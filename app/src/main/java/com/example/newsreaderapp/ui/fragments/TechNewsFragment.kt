...
class TechNewsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentTechNewsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d("TechArticlesFragment", "Email: $email")
        ...
        viewModel.fetchNews(getString(R.string.techchnology_key)) //tech news key for api


        //for placeholder
        binding.searchView.queryHint = getString(R.string.search_Tech)
